...
class UpdatesNetworkDataSource(private val context: Context) : Closeable {
    ...
    companion object {
        ...
        // At ~561 bytes per entry (measured against the live API), 8 KB comfortably fits
        // ~14 entries. The server currently returns 4. A response this large arriving from
        // a metadata-only endpoint is already suspicious and warrants a hard stop.
        private const val MAX_BODY_SIZE_BYTES = 8 * 1024
    }
}
