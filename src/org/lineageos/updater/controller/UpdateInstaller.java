...
class UpdateInstaller {
    ...
    private File getDestinationFile(File file) {
        ...
        try {
            // Devices without a cache partition symlinks /data/cache to /cache.
            // RecoverySystem doesn't uncrypt files whose path starts with
            // /cache, but it doesn't resolve symlinks, so make sure our
            // /cache isn't in /data.
            hasCache = !cachePath.getCanonicalPath().startsWith("/data");
