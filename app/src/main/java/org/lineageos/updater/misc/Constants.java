...
public final class Constants {
    ...
    public static final String PREF_HAS_SEEN_INFO_DIALOG = "has_seen_info_dialog";
    public static final String PREF_HAS_SEEN_WELCOME_MESSAGE = "has_seen_welcome_message";
}
