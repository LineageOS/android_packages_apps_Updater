    ...
    private void showPreferencesDialog() {
        ...
        if (Utils.isRecoveryUpdateExecPresent()) {
            if (!Utils.isRecoveryUpdateExecStubbedOut()) {
                ...
                // We forced disabled the feature to avoid installing stock recovery
                // on A-only prebuilt vendors
                updateRecovery.setVisibility(View.GONE);
            }
        } else {
            // Force the Switch to show as checked on A/B or
            // recovery-in-boot/recovery-in-vendor_boot devices
