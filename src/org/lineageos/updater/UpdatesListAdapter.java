...
public class UpdatesListAdapter extends RecyclerView.Adapter<UpdatesListAdapter.ViewHolder> {
    ...
    private void startDownloadWithWarning(final String downloadId) {
        ...
        boolean warn = preferences.getBoolean(Constants.PREF_METERED_CONN_WARNING, true);
        ...
        checkbox.setText(R.string.checkbox_metered_connection_warning);

        new AlertDialog.Builder(mActivity)
                .setTitle(R.string.update_over_metered_connection_title)
                .setMessage(R.string.update_over_metered_connection_message)
                .setView(checkboxView)
                .setPositiveButton(R.string.action_download,
                        (dialog, which) -> {
                            if (checkbox.isChecked()) {
                                preferences.edit()
                                        .putBoolean(Constants.PREF_METERED_CONN_WARNING, false)
                                        .apply();
