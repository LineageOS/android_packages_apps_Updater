...
public final class Constants {
    ...
    public static final int AUTO_UPDATES_CHECK_INTERVAL_DAILY = 0;
    public static final int AUTO_UPDATES_CHECK_INTERVAL_WEEKLY = 1;
    public static final int AUTO_UPDATES_CHECK_INTERVAL_MONTHLY = 2;
