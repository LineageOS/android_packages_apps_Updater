...
public class UpdaterService extends Service {
    ...
    private void prepareForUncryptAndInstall(UpdateInfo update) {
            ...
            public void run() {
                try {
                    ...
                    mNotificationBuilder.setContentTitle(
                            getString(R.string.notification_prepare_zip_error_title));
        ...
        setNotificationTitle(update);
        mNotificationStyle.bigText(getString(R.string.dialog_prepare_zip_message));
        mNotificationBuilder.mActions.clear();
        mNotificationBuilder.addAction(com.android.internal.R.drawable.ic_menu_close_clear_cancel,
    ...
    private void tryStopSelf() {
        if (!mHasClients && !mUpdaterController.hasActiveDownloads() &&
                !mUpdaterController.isInstallingUpdate() && mPrepareUpdateThread == null) {
