...
class UpdateInstaller {
    ...
    void install(String downloadId) {
        ...
        String lastBuildTimestamp = preferences.getString(Constants.PREF_INSTALL_BUILD_TIMESTAMP,
                buildTimestamp);
        boolean isReinstalling = buildTimestamp.equals(lastBuildTimestamp);
        preferences.edit()
                .putString(Constants.PREF_INSTALL_BUILD_TIMESTAMP, buildTimestamp)
