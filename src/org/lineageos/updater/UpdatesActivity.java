...
public class UpdatesActivity extends UpdatesListActivity {
    ...
    private void showPreferencesDialog() {
        ...
        SwitchCompat meteredConnectionWarning = view.findViewById(
                R.id.preferences_metered_connection_warning);
        ...
        meteredConnectionWarning.setChecked(prefs.getBoolean(
                Constants.PREF_METERED_CONN_WARNING, true));
        ...
        new AlertDialog.Builder(this)
                ...
                .setOnDismissListener(dialogInterface -> {
                    prefs.edit()
                            ...
                            .putBoolean(Constants.PREF_METERED_CONN_WARNING,
                                    meteredConnectionWarning.isChecked())
