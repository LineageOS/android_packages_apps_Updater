...
import org.lineageos.updater.misc.Constants.NOTIFICATION_CHANNEL_NEW_UPDATES
import org.lineageos.updater.misc.Constants.NOTIFICATION_ID_NEW_UPDATES
...
class UpdatesCheckWorker(
    ...
    private fun showNotification(context: Context) {
        ...
        val notification = NotificationCompat.Builder(
            context, NOTIFICATION_CHANNEL_NEW_UPDATES
    ...
    companion object {
        ...
        fun schedule(context: Context) {
            ...
            val retryDelay = TimeUnit.HOURS.toMillis(2)
